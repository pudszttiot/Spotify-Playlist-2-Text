...
class PlaylistWorker(QThread):
        ...
        try:
            with open(filename, 'w', encoding='utf-8') as file:
                ...
                for i, track in enumerate(tracks):
                    file.write(f"{i + 1}. {track['artists']} - {track['track_name']} (Spotify URL: {track['track_url']})\n")
        ...
        try:
            with open(filename, 'w', encoding='utf-8') as file:
                ...
                file.write("""
                        ...
                        <footer>
                            <p>Exported from Spotify Playlist Exporter</p>
                        </footer>
                    </div>
                </body>
                </html>
    ...
    def save_tracks_as_csv(self, tracks, filename, playlist_name):
        """Save track details as a CSV file with headers and detailed error handling."""
        try:
